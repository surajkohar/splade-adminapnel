<x-splade-toggle>
    <nav class="bg-white border-b border-gray-100 sticky inset-0 z-50">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center text-xl font-medium text-[#435EBE] font-serif bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
